$(() => { 
    ...
    function Animal(species, lifespan, group, food, description, length, weight, found, summary) {
        ...
        this.createInfoElement = function () {
            $(".animal-info-container").append(`
                ...
                <h3>${this.species}</h3>
                <div class="img-container-main"> <img class="animal-img" src="./img/${this.species}.jpg" heigth=100px width=100px alt="image of ${this.species}"></img></div>
                    <p>${this.summary}</p>
    ...
    let birdArray = [cassowary, songbird, parrot, kookaburra, cockatoo];
    ...
    const welcomeMessage = () => {
        $(".main-content").append(`
            ...
            <h1>Welcome to The Fantastic Zoo</h1> 
            ...
            <p>Check out the brief summary of all of our new friends in the menu on the left. For the enthusiastic animal nerd there is even more to read if you go to the detailed animal pages found in the menu above. And of course we hope you visit us to say hi to our new friends.</p>
